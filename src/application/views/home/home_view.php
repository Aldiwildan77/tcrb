					...
					<div class="row no-gutters panel">
						<?php foreach ($instagram as $key) : ?>
							<div class="col-4">
								...
								<!-- <img class="img-fluid" id="foto-ig" src="<?= $key['url'] ?>" width="100%" alt="" data-toggle="modal" data-target="#exampleModal" data-number="<?= $i ?>"> -->
							</div>
						<?php endforeach; ?>
					</div>
				</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="instagramModalTitle">Modal title</h5>
