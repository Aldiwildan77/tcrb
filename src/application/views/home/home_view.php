...
<section class="section-page dokumentasi text-center" id="dokumentasi">
	<div class="container wow fadeIn" data-wow-offset="197">
		...
		<div class="text-center text-white mb-5">
			...
			<a href="<?= base_url('dokumentasi') ?>" class="mt-4 btn btn-info ">Tampilkan Lebih Banyak</a>
		</div>
	</div>
</section>
<!-- Akhir Dokumentasi -->
	...
	<div class="container wow fadeIn" data-wow-offset="233" data-wow-duration="0.5s">
		<div class="row mb-3">
			<div class="col-sm-12">
				...
				<h6>Tekan pada gambar untuk memperbesar</h6>
			</div>
		</div>
			...
			<div class="col-md-6">
				<div class="row no-gutters panel">
					<?php for ($index = 0; $index < 9; $index++) : ?>
						<div class="col-4">
							<img class="img-fluid instafoto" id="foto-ig" src="" width="100%" alt="" data-loop="<?= $index ?>" data-width="" data-toggle="modal" data-target="#instagramModal" data-link="">
						</div>
					<?php endfor; ?>
				</div>
			</div>
