        ...
        <!-- <div class="slider-container">
          <div class="slider-content">
            <div class="slider-single">
              <img class="slider-single-image" src="<?= base_url('assets/panitia/img/Inti.png') ?>" alt="1" />
            </div>

            <div class="slider-single">
              <img class="slider-single-image" src="<?= base_url('assets/panitia/img/Kapel.png') ?>" alt="2" />
            </div>

            <div class="slider-single">
              <img class="slider-single-image" src="<?= base_url('assets/panitia/img/Wakapel.png') ?>" alt="3" />
            </div>


            <div class="slider-single">
              <img class="slider-single-image" src="<?= base_url('assets/panitia/img/Benpel.png') ?>" alt="4" />
            </div>


            <div class="slider-single">
              <img class="slider-single-image" src="<?= base_url('assets/panitia/img/inti.png') ?>" alt="5" />
            </div>
        ...
        <div class="body">
          <div class="wrapper">
            ...
            <div class="slider-wrapper">
              <div class=inner>
                <article>
                  <img src="<?= base_url('assets/panitia/img/Inti.png') ?>" />
                </article>
                <article>
                  <img src="<?= base_url('assets/panitia/img/Kapel.png') ?>" />
                </article>
                <article>
                  <img src="<?= base_url('assets/panitia/img/Wakapel.png') ?>" />
                </article>
                <article>
                  <img src="<?= base_url('assets/panitia/img/Benpel.png') ?>" />
                </article>
                <article>
                  <img src="<?= base_url('assets/panitia/img/Acara-s.png') ?>" />
                </article>
                <article>
                  <img src="<?= base_url('assets/panitia/img/Acara.png') ?>" />
                </article>
                <!-- 6 -->
              </div>
              <!-- .inner -->
