                        ...
                        <td width="600" valign="top" align="center" style="border-collapse:collapse;">
                            <table align='center' border='0' cellpadding='0' cellspacing='0' style='border: 1px solid #E0E4E8;' width='100%'>
                                ...
                                <tr>
                                    <td align='left' style='padding: 0 56px 28px 56px;' valign='top'>
                                        <div style='font-family: "lato", "Helvetica Neue", Helvetica, Arial, sans-serif; line-height: 28px;font-size: 18px; color: #333;'>Please click the following link to confirm that <strong><?= $email?></strong> is
                                            your email address and to activate your account:</div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                fillcolor="#E15718">
                                  <w:anchorlock/>
                                <![endif]-->
                                            <a style="background-color:#E15718;border-radius:50px;color:#ffffff;display:inline-block;font-family: &#39;lato&#39;, &#39;Helvetica Neue&#39;, Helvetica, Arial, sans-serif;font-size:18px;line-height:44px;text-align:center;text-decoration:none;width:250px;-webkit-text-size-adjust:none;" href="<?= $link;?>">Activate my account</a>
                                            <!--[if mso]>
                                </v:roundrect>
                              <![endif]-->
                                        </div>
