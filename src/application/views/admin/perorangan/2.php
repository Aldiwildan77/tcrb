...
<body>
  <div class="container-fluid mt-3">
    <div class="row">
      <div class="col-lg-12">
        <h3 class="text-center">Perorangan Sudah Divalidasi</h3>
        <a href="<?= base_url('admin/home') ?>" class="btn btn-dark btn-sm mb-1">Home</a>
        <a href="<?= base_url('admin/orang') ?>" class="btn btn-dark btn-sm mb-1">Kembali</a>
