    ...
    <div class="my-5" style="height: 50vh">
        <div class="login-card card mx-auto">
            <div class="card-body">
                ...
                <p class="card-text ">Fill in your username or email address and we'll send you an email.</p>
                <form action="" method="post">
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Username / Email" id="exampleInputEmail1" name="input">
