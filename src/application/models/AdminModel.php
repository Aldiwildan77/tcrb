...
class AdminModel extends CI_Model
{
	...
	{
    return $this->db->select('p.nama as nama_pemain, p.nim, p.jenis_kelamin, p.instansi, p.jurusan, p.foto_diri, p.foto_kartu_pelajar, k.nama as nama_kategori, k.id as kategori_id, p.user_id as user_id')
  ...
  {
    return $this->db->where('kategori_id', '5')->or_where('kategori_id', '6')->or_where('kategori_id', '7')->or_where('kategori_id', '21')->get('regu')->result_array();
  }
  ...
  public function getAllDataPendaftaranRegu(){
    return $this->db->select('r.id, r.nama as nama_regu, r.instansi, k.nama as nama_kategori, r.user_id as user_id, k.id as kategori_id')
